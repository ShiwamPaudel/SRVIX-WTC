      ...
      <Card className="transition hover:-translate-y-0.5 hover:shadow-md">
        <CardContent className="p-4">
          <div className="grid gap-4 lg:grid-cols-[1fr_220px_auto] lg:items-center">
            ...
            <div className="flex h-24 w-full max-w-[220px] items-center justify-center overflow-hidden rounded-md border border-slate-200 bg-slate-50 lg:w-[220px]">
              {ticket.machine?.ImageURL ? (
                <img src={ticket.machine.ImageURL} alt={ticket.machine.Model || "Machine"} className="h-full w-full object-contain" />
              ) : (
